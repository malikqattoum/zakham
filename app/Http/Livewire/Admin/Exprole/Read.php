...
class Read extends Component
{
    ...
    protected $listeners = ['exproleDeleted'];

    public $sortType;
    public $sortColumn;

    public function exproleDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('exprole');
        ...
        return view('livewire.admin.exprole.read', [
            'exproles' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Exprole')) ]);
    }
}
