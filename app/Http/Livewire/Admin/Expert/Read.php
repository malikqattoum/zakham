...
class Read extends Component
{
    ...
    protected $listeners = ['expertDeleted'];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.expert.read', [
            'experts' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Expert')) ]);
    }
}
