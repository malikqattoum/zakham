...
class Read extends Component
{
    ...
    protected $listeners = ['userinitiativeDeleted'];

    public $sortType;
    public $sortColumn;

    public function userinitiativeDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.userinitiative.read', [
            'userinitiatives' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Userinitiative')) ]);
    }
}
