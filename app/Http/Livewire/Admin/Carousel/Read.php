...
class Read extends Component
{
    ...
    protected $listeners = ['carouselDeleted'];

    public $sortType;
    public $sortColumn;

    public function carouselDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('carousel');
        ...
        return view('livewire.admin.carousel.read', [
            'carousels' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Carousel')) ]);
    }
}
