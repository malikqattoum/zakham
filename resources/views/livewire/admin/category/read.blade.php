            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('active')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'active') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'active') fa-sort-amount-up ml-2 @endif'></i> {{ __('Active') }} </td>
