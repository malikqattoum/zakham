<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Subcategory') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <!-- Ar_name Input -->
            <div class='form-group'>
                <label for='inputar_name' class='col-sm-2 control-label'> {{ __('Arabic Name') }}</label>
            ...
            <!-- Cat_id Input -->
            <div class='form-group'>
                <label for='inputcat_id' class='col-sm-2 control-label'> {{ __('Main Category') }}</label>
