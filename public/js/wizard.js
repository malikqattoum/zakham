$( document ).ready(function() {
    ...
    //   let phone = $('#phone').val();
      ...
      // $.ajax({
      //   url: "/profile/personal-info-store",
      //   type:"POST",
      //   data:{
      //     "_token": "{{ csrf_token() }}",
      //     birthdate:birthdate,
      ...
      //     $('#birthdateErrorMsg').text(response.responseJSON.errors.name);
      //     $('#langErrorMsg').text(response.responseJSON.errors.email);
      //     $('#genderErrorMsg').text(response.responseJSON.errors.mobile);
      //     $('#phoneErrorMsg').text(response.responseJSON.errors.message);
      //   },
      //   });
      // });
